  ...
  return (
    <div className="main-navbar">
            <div className="site-logo mr-5">
                <img src="assets/images/nav-logo.png" className="img-responsive" />
            </div>
            ...
            <div className="navbar">
                ...
                <button className="nav-btn menu-btn allsites-btn" type="button" data-toggle="modal"
                ...
                <div className="nav-colapse-weap">
                    <button className="nav-btn notification-btn nv-col-bt">
                    ...
                    <div className="notification-panel">
                        <div className="notification-list-header">
                            <div className="d-flex justify-content-between align-items-center p-3">
                                ...
                                <div className="btn-group">
                                    <div className="nav-colapse-weaper not-fltr">
                                        <button className="btn-transperent" type="button" data-toggle="collapse"
                                            data-target="#not-filter-colaps" aria-expanded="false"
                                            aria-controls="not-filter-colaps">
                                        ...
                                        <div className="collapse main-submenu" id="not-filter-colaps">
                                    ...
                                    <button className="btn-transperent notification-cls-btn">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <ul className="notification-list p-0">
                                ...
                                <div className="noti-itm">
                                    <div className="media">
                                        <div className="notific-icon align-self-center">
                                            <svg width="24" height="26" viewBox="0 0 24 26" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#041D36" stroke-opacity="0.6" stroke-width="1.5"
                                        ...
                                        <div className="media-body new-noti-body">
                                            <h5><strong>Nilesh joshi</strong> just updated booking status for
                            ...
                            {/* <li className="notification-list-itm text-center">
									<a href="">Clear all</a>
								</li> */}
                        </ul>
                    </div>
                ...
                <div className="nav-colapse-weaper">
                    <button className="user-profile nv-col-bt" type="button" data-toggle="collapse"
                        data-target="#submenu-colapse" aria-expanded="false" aria-controls="submenu-colapse">
                        <div className="profile-wrapper">
                            <div className="user-profile-image" style={{backgroundImage: `url('assets/images/user-profile.png')`}}>
                            </div>
